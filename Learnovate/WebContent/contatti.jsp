...
<body>
	...
	<div style="background-image: url(img/bg-img/hero-1.jpg)">
		...
		<div class="contact-form-area equal-height"
			style="width: 1000px; margin: 0 auto; margin-bottom: 0px;">


			<div class="contact-form">
				<div class="contact-form-title">
					<h6>Contattaci</h6>
					<p>I nostri collaboratori sono completamente a tua disposizione
						per chiarire qualunque suo dubbio.</p>

				</div>
				<form action="${pageContext.request.contextPath}/assistenzaServlet"
					method="GET">
					<div class="row">
						...
						<div class="col-12">
							<textarea name="message" class="form-control" id="Message"
								cols="30" rows="10" placeholder="Inserisci qui il tuo testo"></textarea>
						</div>
						<div class="col-12">
		...
		<div id="mapid"
			style="height: 400px; width: 1500px; margin: 0 auto; margin-top: 0px;"></div>
   ...
   L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZG9vbWluYXRvcjk2IiwiYSI6ImNqcXpmc2ptbjAyZnU0NG1tMWliZ2U4aHAifQ.69_g0vnKd5cqQVpKyuZVAQ', {
	    ...
	    accessToken: 'your.mapbox.access.token'
   	  ...
   	  marker = new L.marker([39.36313478989668,16.22600188219144]).bindPopup("<b>"+"Learnovate"+"</b>").openPopup();  
	  marker.addTo(mymap);        
   </script>
