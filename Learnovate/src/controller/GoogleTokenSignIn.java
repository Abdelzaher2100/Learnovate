...
public class GoogleTokenSignIn extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Hellowwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww");
	...
	//	GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder( transport , jsonFactory)
		...
		String idTokenString = req.getParameter("idTokenString");
		 ...
		 //String pictureUrl = (String) payload.get("picture");
		   ...
		   System.out.println(name+" "+email+" "+emailVerified+" "+locale+" "+familyName+" "+givenName+" ");
